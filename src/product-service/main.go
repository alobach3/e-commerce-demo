...
func (s *server) ListProducts(ctx context.Context, req *pb.Empty) (*pb.ProductList, error) {
	...
	products := []*pb.Product{
		{Id: 1, Name: "Anime Figure 1/6", Category: "figure", Price: 219, Image: "https://via.placeholder.com/400x400"},
		...
		{Id: 5, Name: "Abune Bundle", Category: "bundle", Price: 384, Image: "https://via.placeholder.com/400x400"},
	}
